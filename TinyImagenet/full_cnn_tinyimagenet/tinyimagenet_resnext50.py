...
test_neural_code_dir = '/export/leishiye/neural_code_tinyimagenet/neural_code_resnext50/resnext50_test_code_layer_'
train_neural_code_dir = '/export/leishiye/neural_code_tinyimagenet/neural_code_resnext50/resnext50_train_code_layer_'
...
test_label_scalar = np.load('/export/leishiye/neural_code_tinyimagenet/neural_code_resnext50/test_label.npy')
train_label_scalar = np.load('/export/leishiye/neural_code_tinyimagenet/neural_code_resnext50/train_label.npy')
...
np.save('/export/leishiye/results/resnext50_tinyimagenet_results_num_class' + str(num_class), np.array([test_clustering_accuracy_kmeans, train_clustering_accuracy_kmeans, knn_accuracy, logistic_accuracy]))