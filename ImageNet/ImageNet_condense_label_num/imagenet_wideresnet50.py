...
np.save('/public/data1/users/leishiye/neural_code/results/neural_code_wideresnet50/wideresnet50_results_num_class' + str(num_class), np.array([clustering_accuracy_kmeans, knn_accuracy, logistic_accuracy]))