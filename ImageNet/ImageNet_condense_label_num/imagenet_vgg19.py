...
np.save('/public/data1/users/leishiye/neural_code/results/neural_code_vgg19/vgg19_results', np.array([clustering_accuracy_kmeans, knn_accuracy, logistic_accuracy]))