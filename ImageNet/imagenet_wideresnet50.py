...
neural_code_dir = '/public/data1/users/leishiye/neural_code/results/neural_code_wideresnet50/wideresnet50_code_layer_'
...
label_scalar = np.load('/public/data1/users/leishiye/neural_code/results/neural_code_wideresnet50/imagenet_val_label.npy')
...
np.save('/public/data1/users/leishiye/neural_code/results/neural_code_wideresnet50/wideresnet50_results', np.array([clustering_accuracy_kmeans, knn_accuracy, logistic_accuracy]))