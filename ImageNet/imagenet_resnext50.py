...
neural_code_dir = '/public/data1/users/leishiye/neural_code/results/neural_code_resnext50/resnext50_code_layer_'
...
label_scalar = np.load('/public/data1/users/leishiye/neural_code/results/neural_code_resnext50/imagenet_val_label.npy')
...
np.save('/public/data1/users/leishiye/neural_code/results/neural_code_resnxet50/resnext50_results', np.array([clustering_accuracy_kmeans, knn_accuracy, logistic_accuracy]))