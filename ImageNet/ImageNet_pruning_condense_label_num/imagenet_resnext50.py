...
neural_code_dir = '/export/leishiye/neural_code/neural_code_resnext50/resnext50_code_layer_'
for i in range(17):
...
label_scalar = np.load('/export/leishiye/neural_code/neural_code_resnext50/imagenet_val_label.npy')
...
np.save('/public/data1/users/leishiye/neural_code/results/neural_code_resnxet50/resnext50_results_prune_num_class' + str(num_class), np.array([clustering_accuracy_kmeans, knn_accuracy, logistic_accuracy]))